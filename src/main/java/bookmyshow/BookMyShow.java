...
public class BookMyShow {
    ...
    public void createBooking(City userCity, String movieName) {
        ...
        if (!bookedSeats.contains(seatNumber)) {
            ...
            //startPayment
            Seat bookedSeat = interestedShow.getScreen().getSeats().stream()
                    .filter(seat -> seat.getSeatId() == seatNumber)
                    .findFirst()
    ...
    private void createTheatre() {
        ...
        Show inoxMorningShow = createShow(1, inoxTheatre.getScreen().get(0), avengerMovie, 8);
        Show inoxEveningShow = createShow(2, inoxTheatre.getScreen().get(0), baahubali, 16);
        ...
        Show pvrMorningShow = createShow(3, pvrTheatre.getScreen().get(0), avengerMovie, 13);
        Show pvrEveningShow = createShow(4, pvrTheatre.getScreen().get(0), baahubali, 20);
